...
export default function RelationshipsPage() {
    ...
    return relationships.filter((rel) => {
      ...
      if (selectedRegion !== 'all') {
        ...
        const p1TopRegion = p1?.regionId
          ? getRegionById(p1.regionId)?.parentRegionId || p1.regionId
          : null;
        const p2TopRegion = p2?.regionId
          ? getRegionById(p2.regionId)?.parentRegionId || p2.regionId
          : null;
  ...
  }, [selectedTypes, selectedRegion, selectedEra, personMap]);
        ...
        <div className="mt-6 p-6 border border-stone-200 rounded-xl bg-white">
            ...
            <div>
              ...
              {selectedPerson.regionId && (
                <span className="inline-block mt-1 text-xs px-2 py-0.5 rounded border border-stone-200 bg-stone-50 text-stone-500">
                  {regionName(
                    getRegionById(selectedPerson.regionId)!,
                    locale
                  )}
                </span>
              )}
          ...
          <div className="mt-4">
            ...
            <div className="flex flex-wrap gap-2">
              {getRelationshipsForPerson(selectedPerson.id).map((rel) => {
                const otherId =
